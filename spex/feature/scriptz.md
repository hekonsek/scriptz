...
This project exports Spex package with [instructions](../instruction/terminal_session_script_instructions.md) on how agents should use logs generated by `scriptz`.